...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="CLI version of PuLID for FLUX")

    parser.add_argument("--version", type=str, default="v0.9.1", choices=['v0.9.0', 'v0.9.1'])
    parser.add_argument("--name", type=str, default="flux-dev", help="Model name, e.g., flux-dev")
    ...
    parser.add_argument("--pretrained_model", type=str, required=True, help="Path to pretrained .safetensors")
    parser.add_argument("--input_image", type=str, required=True, help="Path to ID image (input)")
    parser.add_argument("--output", type=str, default="output.jpg", help="Path to save result image")
    ...
    parser.add_argument("--neg_prompt", type=str, default="bad quality, worst quality, watermark, text")
    parser.add_argument("--true_cfg", type=float, default=1.0)
    parser.add_argument("--timestep_to_start_cfg", type=int, default=1)
    ...
    result_img, used_seed, _ = generator.generate_image(
        width=args.width,
        height=args.height,
    ...
    print(f"✅ Done! Saved result image to: {args.output}")
